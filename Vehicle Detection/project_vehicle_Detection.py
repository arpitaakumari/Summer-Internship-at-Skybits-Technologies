...
#loading video
cap=cv2.VideoCapture("F:/objectdetection/Drone2.mp4")
...
while True:
    ...
    for i in range(len(boxes)):
        if i in indexes:
            ...
            if(label == 'train'):
                label='truck'
            if label=='car' or label=='motorbike' or label=='bicycle' or label=='truck' or label=='bus':
    ...
    if writer is None:
        ...
        writer = cv2.VideoWriter("output_vehicle.avi", fourcc, 30,
